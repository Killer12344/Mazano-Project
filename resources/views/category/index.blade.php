...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="font-weight-bolder mb-3"><i class="feather-plus-circle"></i> Add Category</h4>
                    <form action="{{ route('category.store') }}" method="post">
                        @csrf
                        <div class="form-group">
                            <div class="mb-3">
                                <input type="text" autofocus name="title" placeholder="" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}">
                                @error('title')
            ...
            <table class="table table-bordered mt-4 table-hover">
                ...
                @forelse($categories as $category)
                    <tr>
                        ...
                        <td class="">
                            <a href="{{ route('category.edit',$category->id) }}" class="btn btn-warning btn-sm"><i class="feather-edit"></i></a>
